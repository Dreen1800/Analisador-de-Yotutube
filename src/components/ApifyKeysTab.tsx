    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <h3 className="text-lg font-medium text-gray-900">Apify API Keys</h3>
                ...
                {apifyKeys.length === 0 && !isLoading ? (
                    <div className="p-6 text-center text-gray-500">
                        ...
                        <p className="text-sm mt-2">
                            You can get your Apify API token from <a href="https://console.apify.com/account/integrations" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:text-purple-700">Apify Console</a>
                        </p>
                    </div>
                ) : (
            ...
            <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
                <h4 className="text-sm font-medium text-gray-900">About Apify API Keys</h4>
