...
import { Eye, EyeOff, Plus, Trash, Check, X, Key, Info, AlertCircle, Youtube, Brain } from 'lucide-react';
...
const ApiKeysModal = ({ isOpen, onClose }: ApiKeysModalProps) => {
    ...
    }, [isOpen, fetchApiKeys, fetchOpenAIKeys]);
    ...
    const getApiSubtitle = () => {
        return activeTab === 'youtube'
            ? 'Gerencie suas chaves para a API do YouTube Data'
            : 'Gerencie suas chaves para a API da OpenAI (para funcionalidades de IA)';
    };
    ...
    const getHelpText = () => {
        return activeTab === 'youtube'
            ...
            : 'Uma chave da API OpenAI é necessária para usar funcionalidades de IA como análise de concorrentes. Você pode criar sua chave no site da OpenAI.';
    };

    const getKeySuffix = () => {
        return activeTab === 'youtube' ? 'API YouTube' : 'API OpenAI';
    };
                ...
                <div className="p-6">
                    ...
                    <div className="bg-gray-50 rounded-xl p-5 border border-gray-200 shadow-sm">
                        <h3 className="text-lg font-medium text-gray-900 mb-3 flex items-center">
                            ...
                            {activeTab === 'youtube' ? 'Sobre Chaves de API do YouTube' : 'Sobre Chaves da OpenAI'}
                        </h3>
                        <div className="text-sm text-gray-600 space-y-3">
                            ...
                            <p>
                                {activeTab === 'youtube' ? 'Para criar uma chave API do YouTube:' : 'Para criar uma chave API da OpenAI:'}
                            </p>
                            {activeTab === 'youtube' ? (
